...
<head>
    ...
    @include('client.layout.link_header')
    @include('client.layout.script_header')
    @yield('css')
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="{{route('client.home')}}">
                Zay
            </a>
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="#">
                        ...
                        <span
                            ...
                            {{session()->get('cart')!= null ? count(session()->get('cart')) : '0'}}</span>
                    </a>
                    @if (Auth::check())
                    <a class="nav-icon position-relative text-decoration-none" href="{{route('client.profile')}}">
                        <img src="{{Storage::url(Auth::user()->avatar)}}" width="35" alt="Avatar" class="rounded-circle">   
                    </a>
                    @endif
                </div>
            </div>
    ...
    <div class="modal fade bg-white" id="templatemo_search" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <form action="{{route('client.home')}}" method="get" class="modal-content modal-body border-0 p-0">
                @csrf
    ...
    @include('client.layout.script_footer')
    @yield('script_footer')
